...
export class SocialScheduler {
    ...
    this.scheduleQueue = [
      {
        ...
        content: {
          ...
          link: 'https://theloadcalc.com/blog/best-solar-generators-2026',
          image: 'https://theloadcalc.com/images/blog/solar-generators-2026.jpg'
        },
      ...
      },
      {
        ...
        platform: 'twitter',
        content: {
          text: 'Did you know? A 2000Wh solar generator can run a refrigerator for 12+ hours! Check out our calculator to find your perfect setup. https://theloadcalc.com/calculators/battery-runtime'
        },
      ...
      },
      {
        ...
        content: {
          ...
          link: 'https://theloadcalc.com/blog/van-life-solar-setup-guide',
          image: 'https://theloadcalc.com/images/blog/van-life-solar.jpg'
        },
      ...
      },
      {
        ...
        content: {
          ...
          link: 'https://theloadcalc.com/calculators/solar-sizing'
        },
      ...
      },
      {
        ...
        platform: 'twitter',
        content: {
          text: 'Just published: EcoFlow vs Bluetti - Which solar generator is right for you? Read our full comparison! https://theloadcalc.com/blog/ecoflow-vs-bluetti-comparison'
        },
      ...
      },
      {
        ...
        content: {
          ...
          link: 'https://theloadcalc.com/blog/home-battery-backup-guide',
          image: 'https://theloadcalc.com/images/blog/home-battery-backup.jpg'
        },
  ...
  generateDailyPinterestContent() {
    ...
    return {
      ...
      link: `https://theloadcalc.com${randomBlog.url}`,
      image: `https://theloadcalc.com/images/blog/${randomBlog.url.split('/').pop()}.jpg`
    }
  }
  ...
  generateEveningPinterestContent() {
    ...
    return {
      ...
      link: `https://theloadcalc.com${randomProduct.url}`,
      image: `https://theloadcalc.com/images/products/${randomProduct.image}`
    }
  }
  ...
  generateDailyTwitterContent() {
    ...
    const tweets = [
      `New on the blog: ${randomBlog.title}! Learn everything you need to know about solar power. https://theloadcalc.com${randomBlog.url}`,
      `Need to size your solar system? Try our ${randomCalculator.title}! Accurate calculations in seconds. https://theloadcalc.com${randomCalculator.url}`,
      `Did you know? Solar power can save you up to 50% on energy bills. Check out our guides at https://theloadcalc.com`,
      `Planning an off-grid adventure? Our ${randomBlog.title} has all the tips you need! https://theloadcalc.com${randomBlog.url}`,
      `⚡️ Power your home with solar! Compare the best generators at https://theloadcalc.com`
    ]
  ...
  generateEveningTwitterContent() {
    ...
    const tweets = [
      `🔆 Don't miss our ${randomBlog.title}! Expert insights and practical advice. https://theloadcalc.com${randomBlog.url}`,
      `Ready to go off-grid? Start with our ${randomCalculator.title} for accurate planning. https://theloadcalc.com${randomCalculator.url}`,
      `🏠 Home backup power made easy! Learn how to stay powered during blackouts. https://theloadcalc.com/blog/blackout-emergency-power-plan`,
      `📈 2026 Solar Market Trends: What you need to know! Read more at https://theloadcalc.com/blog/solar-market-trends-2026`
    ]
