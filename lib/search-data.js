...
const calculators = [
  ...
  { title: 'Panel Degradation Calculator', type: 'calculator', url: '/calculators/panel-degradation', keywords: 'panel degradation loss per year solar output decline aging lifespan efficiency' },
  { title: 'Temperature Coefficient Loss Calculator', type: 'calculator', url: '/calculators/temperature-coefficient-loss', keywords: 'temperature coefficient loss heat solar panel output hot summer derating' },
  { title: 'Shading Impact Calculator', type: 'calculator', url: '/calculators/shading-impact', keywords: 'shading impact loss coverage percent solar panel tree shadow partial series parallel optimizer' },
  { title: 'Dust & Soiling Loss Estimator', type: 'calculator', url: '/calculators/dust-soiling-loss', keywords: 'dust soiling loss estimator dirt pollen cleaning solar panel desert urban rainfall' },
  { title: 'Solar Panel Hotspot Risk Calculator', type: 'calculator', url: '/calculators/panel-hotspot-risk', keywords: 'solar panel hotspot risk fire hazard bypass diode crack delamination thermal' },

  // Battery & Component Economics
  { title: 'Battery Lifetime Cost Calculator', type: 'calculator', url: '/calculators/battery-lifetime-cost', keywords: 'battery lifetime cost per kwh cycle economics cost of ownership lithium lead acid grid comparison' },
  { title: 'Battery DoD Degradation Calculator', type: 'calculator', url: '/calculators/battery-dod-degradation', keywords: 'battery cycle degradation depth of discharge dod lifepo4 lithium lead acid cycle life stress' },
  { title: 'Inverter Replacement Calculator', type: 'calculator', url: '/calculators/inverter-replacement', keywords: 'inverter replacement interval lifespan string hybrid microinverter cost of ownership 25 year' }
]
...
const aboutPages = [
  ...
  { title: 'Contact Us', type: 'about', url: '/contact', keywords: 'contact us support help email' },
  { title: 'Affiliate Disclosure', type: 'about', url: '/affiliate-disclosure', keywords: 'affiliate disclosure' },
  { title: 'Privacy Policy', type: 'about', url: '/privacy-policy', keywords: 'privacy policy' },
  { title: 'Terms of Service', type: 'about', url: '/terms', keywords: 'terms of service legal conditions' }
